...
class BootstrapSkillLevels {
    ...
    static ArrayList<SkillLevel> init() {
        ...
        skillLevels = SkillLevel.findByI18Name("s2") ?: new SkillLevel(nameCZ: "2 - Mierne pokročilý", nameEN: "2 - Intermediate", nameSK: "2 - Začiatočník", i18Name: "s2", posOrder: 2).save(flush: true, failOnError: true)
        skills.add(skillLevels)
