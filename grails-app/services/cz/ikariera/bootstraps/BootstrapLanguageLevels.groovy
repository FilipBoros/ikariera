...
class BootstrapLanguageLevels {
    ...
    public static ArrayList<LanguageLevel> init() {
        ...
        languages.add(languageLevels)
        languageLevels = LanguageLevel.findByI18Name("b2") ?: new LanguageLevel(nameCZ: "B2 - Vyšší", i18Name: "b2", nameEN: "B2 - Upper intermediate", nameSK: "B2 - Vyšší", posOrder: "4").save(flush: true, failOnError: true)
        languages.add(languageLevels)
