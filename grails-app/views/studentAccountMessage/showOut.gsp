...
<div class="row">
    ...
    <div class="large-9 columns">
        ...
        <h2><g:message code="student.dialogs.outbox.detail" /> </h2>
    ...
    <div class="large-3 columns">
        ...
        <g:link controller="studentAccountMessage" action="outbox" class="button right secondary">
...
<div class="row">
    <g:form controller="studentAccountMessage" action="replyOutbox">
