...
<div class="row">
    ...
    <div class="large-12 columns">
        ...
        <h2><g:message code="company.users.label"/></h2>
...
<div class="row">
    ...
    <div class="large-12 columns">
        ...
        <g:form method="get" controller="adminUserCompany">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <g:sortableColumn property="company.companyName"
                                  title="${message(code: 'admin.listUsers.company')}" style="width: 150px;"/>
            ...
            <g:else>
                <g:each in="${userInstanceList}" status="i" var="userInstance">
                    ...
                    %{--neaktivni uzivale budou mit cerveny username--}%
                    ...
                    %{--<td colactive="3">${userInstance?.authorities?.authority} </td>--}%
                        ...
                        <td colactive="4">${userInstance?.company?.companyName}</td>
                        ...
                        <td colactive="7"><g:formatDate date="${userInstance?.lastLoginDate}"
                                                        format="dd.MM.yyyy"/></td>


                        <td colactive="9"
                            style="text-align: center;">${userInstance?.enabled ? message(code: 'admin.success.yes') : "N"}</td>

                        <td colactive="6"
                            style="text-align: center;">${userInstance?.accountLocked ? "BAN" : "-"}</td>
