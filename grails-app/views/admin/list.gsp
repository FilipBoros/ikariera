...
<div class="row">
    ...
    <div class="large-12">
        ...
        <h2><g:message code="users.list.label"/></h2>
...
<div class="row">
    ...
    %{--
    <g:render template="/layouts/adminLayout/pagination"
              model="[displayedResults: displayedResults, instanceTotal: userInstanceTotal, params: params]"/>
    --}%
