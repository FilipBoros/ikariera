<div class="panel detailInfo">
    ...
    <div>
        ...
        <p id="jobOfferType">${message(code: jobOfferInstance?.jobOfferType?.i18NameFull)}
    ...
    <g:if test="${jobOfferInstance?.jobOfferPositionLevel || jobOfferInstance?.jobOfferPositionLevel}">

<hr>


       <p>   ${message(code: jobOfferInstance?.jobOfferPositionLevel?.i18NameFull)}




            ${message(code: jobOfferInstance?.jobOfferPosition?.i18NameFull)}
