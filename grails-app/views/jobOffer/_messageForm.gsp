%{--<g:uploadForm controller="message" action="send">--}%
<g:uploadForm controller="studentAccountMessage" action="jobOfferReply">
...
%{--    <g:hiddenField name="mail" value="${sec.loggedInUserInfo(field: 'username')}"/>--}%
    ...
    <h3> ${jobOfferInstance?.company?.companyName} </h3>
    ...
    <button class="button"><g:message code="message.send"/></button>
